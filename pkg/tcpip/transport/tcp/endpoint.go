...
// WakeupWritersOnSetSendBufferSize implements tcpip.SocketOptionsHandler.WakeupWritersOnSetSendBufferSize.
func (e *endpoint) WakeupWritersOnSetSendBufferSize() {
	e.LockUser()
	defer e.UnlockUser()
...
func (e *endpoint) computeTCPSendBufferSize() int64 {
	...
	// size should be set to SndCwnd*MSS to accomodate sending of all the
	// segments.
